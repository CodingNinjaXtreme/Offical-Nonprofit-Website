...
const socials = [
  { icon: Instagram, href: 'mailto:admin@InfinityMath4All.org', label: 'Email us about Instagram' },
  { icon: Linkedin, href: 'mailto:admin@InfinityMath4All.org', label: 'Email us about LinkedIn' },
];
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center gap-2 mt-5">
              {socials.map(({ icon: Icon, href, label }) => (
                <a
                  ...
                  href={href}
                  aria-label={label}
                  className="w-9 h-9 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 flex items-center justify-center text-slate-300 hover:text-white transition-all duration-200"
                >
        ...
        <div className="border-t border-slate-800 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-slate-500">
            &copy; {new Date().getFullYear()} InfinityMath4All. All rights reserved. 501(c)(3) Nonprofit.
          </p>
