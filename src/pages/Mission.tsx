        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-12 gap-12 items-start">
            <div className="lg:col-span-5">
              ...
              <p className="text-slate-500 leading-relaxed mb-5">
                Our model is simple: <strong className="text-slate-800">high school students who recently competed</strong> coach the
                next generation. They understand the curriculum because they lived it. They
                understand the students because they were the students.
              </p>
              <p className="text-slate-500 leading-relaxed">
                Every program is free or subsidized. We focus on Noetic, MOEMS, and Elementary
                Grade-Level Math — the three competitions and programs that build the foundation
                of every serious young mathematician&rsquo;s journey.
              </p>
            </div>
